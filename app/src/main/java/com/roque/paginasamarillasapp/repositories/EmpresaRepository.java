...
public class EmpresaRepository {
    ...
    private EmpresaRepository() {
        ...
        addEmpresa(new Empresa(0, "NANKA", "Restaurante", "Jr. Bambues 198, La Molina, Lima 15024, Perú", "+51 1 3697297",
                "reservas@nanka.pe", "www.nanka.pe", "Peruana, Latina, Mediterránea", R.drawable.img_nanka));
        addEmpresa(new Empresa(1, "Maido", "Restaurante", "Calle San Martín 399, Lima Lima 18, Perú", "+51 1 4462512",
                "informes@maido.pe", "www.maido.pe", "Japonesa, Peruana, Mariscos, Sushi", R.drawable.img_maido));
        addEmpresa(new Empresa(2, "Bao?", "Restaurante", "Calle Jose Domingo Choquehuanca 411, Lima lima 18, Perú", "(01)4834180",
        ...
        addEmpresa(new Empresa(3, "Burrito Bar", "Restaurante", "113 Av Miguel Grau|Barranco, Lima 15001, Perú", "+51 982 446 668",
        ...
        addEmpresa(new Empresa(4, "Chicha and Carbo", "Restaurante", "Calle de las Bellas Artes 200, Lima, Perú", "+51 997 725 401",
        ...
        addEmpresa(new Empresa(5, "Edo Sushi Bar", "Restaurante", "San Borja Sur 663, San Borja, Lima, Perú", "225-0881",
                "catering@edosushibar.com", "edosushibar.com", "Japonesa, Sushi, Asiática", R.drawable.img_edosushibar));
        //addEmpresa(new Empresa(6, "", "Restaurante", "", "", "", "", "", R.drawable.img_nanka));
